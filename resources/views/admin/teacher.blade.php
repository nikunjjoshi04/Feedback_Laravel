...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Teacher </li>
            </ol>
<!--grid-->
		...
		{{ csrf_field() }}
         	<div class="vali-form">
					...
					<div class="form-group">
						<label for="exampleInputFile">Teacher phpto</label>
						<input type="file" except=".jpg" name="image" id="image">
						<p class="help-block">Please select teacher image</p>
					</div>
			...
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label ">Birthddate</label>
              <input type="date" name="bdate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
            </div>
             <div class="clearfix"> </div>
            <div class="col-md-12 form-group1 group-mail">
            ...
            <div class="col-md-6 form-group1 form-last">
              ...
              <input type="password" name="cpassword" placeholder="Repeated password" required="">
            </div>
            <div class="clearfix"> </div>
            </div>
