...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Feedback Question </li>
            </ol>
<!--grid-->
 	...
 	<!---->
        ...
        <form action="{{ route('que') }}" method="post">
		@csrf
         	<div class="vali-form">
            <div class="col-md-6 form-group1">
              <label class="control-label">Feedback Question</label>
              <input type="text" name="que" placeholder="Feedback Question" required="">
            </div>
