...
<!-- Div form-->
    <form action="{{ action('DivController@store') }}" method="post">
		{{ csrf_field() }}
		<div class="clearfix"> </div>
		...
		<div class="col-md-12 form-group2 group-mail">
			...
			<select name="sem_id" id="sem_id"></select>
         	...
         	<div class="vali-form">
              ...
              <input type="text" name="div" id="div" placeholder="div" required="">
            	</div>
...
<script type="text/javascript" src="{{ asset('assets/js/bootstrap.min.js') }}"></script>
 <script>
        ...
        $('#class').on('change', function() {
            ...
            if(classID) {
                $.ajax({
                    url: '/findCityWithStateID/'+classID,
                    type: "GET",
                    ...
                    success:function(data) {
                      ...
                      if(data){
                        ...
                        $('select[name="sem_id"]').append('<option value="'+ value.id +'">' + value.sem+ '</option>');
                    });
                  }else{
                    $('#sem_id').empty();
                  }
