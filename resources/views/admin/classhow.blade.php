...
@section('content')
	...
	<table id="table table-hover">
		...
		<tbody>
			@foreach($clas as $data )
				<tr>
					<td>{{$data->id}}</td>
					<td>{{$data->class}}</td>
					<td><a href="{{ route('sem.index') }}" class="btn btn-success">Add Sem</a></td>
					<td><a herf="" class="btn btn-success">Edit</a></td>
					<td><button value="delete" class="btn btn-success">Delete</button></td>
				</tr>
			@endforeach	
		</tbody>
		<a href="class" class="btn btn-success">Add class</a>
	</table>
@endsection
<!-- //tables -->
			</div>
