	   ...
	   <div class="mother-grid-inner">
			...
			<?php
				if(session()->has('admindata')){
					 $tdata =Session::get('admindata')->first();
			 	}
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="suballocate"><i class="fa fa-bar-chart"></i><span>Subject Allocation</span><div class="clearfix"></div></a></li>
