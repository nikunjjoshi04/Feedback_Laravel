...
<body>
	<!--Header-->
	<div class="top-bar_sub_w3layouts_agile mx-auto">
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<!-- <h1><a class="navbar-brand" href="/index">Stretch <span>Online Education</span></a></h1> -->
					</div>
					...
					<li>
						<div class="banner-top">
							<div class="banner-info-w3ls-agileinfo">
								...
								<a href="/about">Read More <i class="fa fa-caret-right" aria-hidden="true"></i></a>
								<a href="/contact">Contact Us <i class="fa fa-caret-right" aria-hidden="true"></i></a>
							</div>
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page">
							...
							<div class="login-form-wthree-agile">
								...
								@csrf
									<input type="text" name="eno" placeholder="Enrollment number" required="">
									...
									<div class="styled-input agile-styled-input-top">
											<select class="category2" name="sem_id" id="sem_id">
												<option disable>Select Sem</option>
											</select>
									</div>
									<div class="styled-input agile-styled-input-top">
											<select class="category2" name="div_id" id="div_id">
												<option disable>Select Div</option>
											</select>
									</div>
									<input type="password" name="password" placeholder="Password" required="">
									@error('password')
